            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="text"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-white text-black"
                    defaultValue="Marihasina"
                  />
                </div>
              </div>
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="email"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-black text-black"
                    defaultValue="marihasina19.aps2b@gmail.com"
                  />
                </div>
              </div>
              <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="w-full lg:w-12/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <textarea
                    type="text"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 text-black"
                    defaultValue="lorem lorem lorem lorem lorem loremlorem lorem loremlorem lorem loremlorem lorem lorem."
                    rows="4"
                  ></textarea>
                </div>
              </div>
